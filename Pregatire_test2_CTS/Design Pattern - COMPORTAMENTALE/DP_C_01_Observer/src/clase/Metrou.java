...
public class Metrou extends MijlocTransport{
    ...
    public Metrou(int numarLinie,
                  String denumirePrimaStatie, String denumireUltimaStatie) {
        super(numarLinie);
    ...
    public void pleacaDeLaCapat() {
        trimiteNotificare("Metroul care merge pe magistrala " + this.getNumarLinie() +
